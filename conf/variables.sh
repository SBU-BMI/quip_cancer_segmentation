...
# Base directory
BASE_DIR=/data01/shared/hanle/tumor_project/train_tumor_classification/quip_cancer_segmentation
...
DATA_PATH='/data01/shared/hanle/tumor_project/breast_cancer_40X/cancer_pos1'        # Change this to your training data folder
